...
'''
обсяг виробничого капіталу (основних фондів) К та обсяг праці L,
які вимірюються: для К – у грошовому або натуральному виразі, а для
L – у кількості робітників, людино-годин, людино-днів та ін.
'''

# CAPITAL
# WARNING, THIS F IS K -_-
